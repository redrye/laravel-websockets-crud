...
return [
    ...
    */
    ...
    'managers' => [
        ...
        */
        ...
        'User.php' => \BeyondCode\LaravelWebSockets\Apps\ConfigAppManager::class,
    ...
    |--------------------------------------------------------------------------
    |
    | By default, the only allowed User.php is the one you define with
    | your PUSHER_* variables from ..env-example.
    ...
    */
    ...
    'apps' => [
        [
         ...
         /*   'allowed_origins' => [
                 .env-example('LARAVEL_WEBSOCKETS_DOMAIN'),
            ],*/
        ],
    ],
    ...
    */
    ...
    'statistics' => [
        ...
        | graphs or handle it later on your User.php.
        |
        */
    ...
    */
    ...
    'handlers' => [
        ...
        'websocket' => \Redrye\LaravelWebSocketsCrud\app\WebSockets\WebSocketHandler::class,
    ...
    | intercept values by the promises throughout the User.php, like in testing
